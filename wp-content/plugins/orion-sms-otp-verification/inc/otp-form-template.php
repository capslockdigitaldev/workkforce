	...
	<div class="my-3 p-3 bg-white rounded box-shadow ihs-api-config-cont">
		...
		<div class="media text-muted pt-3">
			<div class="d-sm-flex media-body ihs-input-wrap pb-3 mb-0 small lh-125 border-bottom border-gray">
				<ul>
					<!--Common Instructions-->
					<li><?php echo __( 'As shown in the tutorial, the plugin works with WordPress default theme twenty nineteen and is tested successfully with top 5 WordPress registration plugins as mentioned in the plugin description.', $text_domain ) ?></li>
...
5-Profile Press
6-RegistrationMagic.) along with WordPress default theme Twenty nineteen.However we cannot gaurantee that the plugin will work for your specific project. The reason for this is that, based on the queries I have been dealing with and solving them in the past, I have observed that the theme or plugins that you are using may add some styles or scripts that may interfere with the default functionality of Orion OTP Plugin', $text_domain ) ?></li>
					<br>
	...
	<div class="my-3 p-3 bg-white rounded box-shadow ihs-api-config-cont">
		...
		<?php require_once 'button-text-settings.php'; ?>
