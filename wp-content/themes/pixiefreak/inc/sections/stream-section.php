        ...
        <div class="container">
            <div class="section-header border-bottom">
                ...
                <div class="section-title">
                    <h2><?php echo esc_html__('Featured Streams', 'pixiefreak'); ?></h2>
                </div>

                <!-- Filter -->
                <ul>
                    <li class="active">
                        <a href="#all-stream" data-toggle="tab"><?php echo esc_html__('All', 'pixiefreak'); ?></a>
                    </li>
            ...
            <div class="section-footer">
                <div>
                    <h4><?php echo esc_html__('If you want to see more streams', 'pixiefreak'); ?></h4>
                ...
                <a href="<?php echo esc_url(get_home_url(null, 'streams/')); ?>" class="btn-default">
			        <?php echo esc_html__('All Streams', 'pixiefreak'); ?>
                </a>
            </div>
        </div>
    </section>
