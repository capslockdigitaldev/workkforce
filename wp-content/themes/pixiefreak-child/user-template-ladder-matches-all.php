<?php 
/*
Template Name: User Ladder Matches all & Request Form
*/
get_header();
                    ...
                    <div class="tab-pane active" id="tab1">
                        <div class="player-rank">
                            <div class="row">
                                ...
                                <div class="matchbox">
                                    <a id="modal-50999" href="#modal-container-50999" role="button" data-toggle="modal"> Create Match and Start Challenging <i class="fas fa-chevron-right"></i></a>
                                </div>
                                    ...
                                    if (isset($_REQUEST['migame']) && isset($_REQUEST['miplat']) && isset($_REQUEST['mitype'])  ) {
                                        
                                                    $game_name = get_field( "game" );
                                                    $game_platform = get_field( "platform" );
                                                    $game_type = get_field( "type" );
                                                    
                                                    
                                                    if( $g_name == $game_name && $game_platform == $g_platform && $game_type == $g_type)
                                                    {
                                                       ?>
                                                       ...
                                                       <div class="list_tournament list_game rob">
                                                            <div class="tournament_image">
                                                                    ...
                                                                    if ($game_name == "nba"){
                                                                        ?>
                                                                        <img class="featuretournament" src="<?php echo get_bloginfo('url') ?>/wp-content/uploads/2019/07/NBA2K19-Front.png">
                                                                        <?
                                                                    }
                                                                    else if ($game_name == "nbal"){
                                                                        ?>
                                                                        <img class="featuretournament" src="<?php echo get_bloginfo('url') ?>/wp-content/uploads/2019/07/Nba-Live.png">
                                                                        <?
                                                                    }
                                                                    else if ($game_name == "fortnite"){
                                                                        ?>
                                                                        <img class="featuretournament" src="<?php echo get_bloginfo('url') ?>/wp-content/uploads/2019/07/Fortnite-Front.png">
                                                                        <?
                                                                    }
                                                                    else if ($game_name == "cod"){
                                                                        ?>
                                                                        <img class="featuretournament" src="<?php echo get_bloginfo('url') ?>/wp-content/uploads/2019/07/COD-BO3-Front.png">
                                                                        <?
                                                                    }
                                                                    else if ($game_name == "madden"){
                                                                        ?>
                                                                        <img class="featuretournament" src="<?php echo get_bloginfo('url') ?>/wp-content/uploads/2019/07/madden19.png">
                                                                        <?
                                                                    }
                                                                    else if ($game_name == "fifa"){
                                                                        ?>
                                                                        <img class="featuretournament" src="<?php echo get_bloginfo('url') ?>/wp-content/uploads/2019/07/FIFA199.png">
                                                                        <?
                                                                    }
                                                                    ?>
                                                                </div>
