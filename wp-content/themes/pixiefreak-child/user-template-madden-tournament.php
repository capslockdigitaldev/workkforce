<?php 
/*
Template Name: User Madden tournaments
*/
get_header();
...
<div class="col-md-6 col-sm-6 col-12 p-0">
	<div class="main-content">
		<div class="main-content support frontline text-left mt-3">
            <h4 class="">Madden Tournaments</h4>
        </div>
                ...
                <div class="tab-pane ative">
                    <div class="player-rank">
                        <div class="row">
                                ...
                                $loop = new WP_Query( array( 'post_type' => 'tournaments', 'paged' => $paged , 'meta_key' => 'game', 'meta_value' => 'mlb' ) );
                                                if ( $loop->have_posts() ) :
