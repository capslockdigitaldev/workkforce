                ...
                <li<?php echo reset($statuses) === $status ? ' class="active"' : ''; ?>>
                    <a  href="#<?php echo esc_attr(strtolower($status) .'-match'); ?>"
						...
						<?php if ($status == 'Upcoming'): ?>
							<?php echo esc_html__('Nadchodzące', 'pixiefreak'); ?>
						<?php else: ?>
							<?php echo esc_html__('Zakończone', 'pixiefreak'); ?>
						<?php endif; ?>
                    </a>
                </li>
			<?php endforeach; ?>
...
<section class="matches">
    <div class="container">
        <div class="inner-page-header">
            <div class="headline">
                <h4><?php echo esc_html__('Select filter option on the right', 'pixiefreak'); ?></h4>
            ...
            <ul class="filter-list">
                <li>
                    <label class="checkbox-container" for="filter-all">
						<?php echo esc_html__('All', 'pixiefreak'); ?>
