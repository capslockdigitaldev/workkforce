<?php 
/*
Template Name: User apex tournaments
*/
get_header();
                ...
                <div class="tab-pane active">
                    <div class="player-rank">
                        <div class="row">
                                ...
                                $loop = new WP_Query( array( 'post_type' => 'tournaments', 'paged' => $paged , 'meta_key' => 'game', 'meta_value' => 'apex' ) );
                                                if ( $loop->have_posts() ) :
