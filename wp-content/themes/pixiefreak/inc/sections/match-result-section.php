        ...
        <div class="container">
            <div class="section-header center-column col-white">
                <div class="section-title">
                    <h2><?php echo esc_html__('Latest Matchesss & Results', 'pixiefreak'); ?></h2>
                    <span><?php echo esc_html__('This is live update of matches our teams playing right now', 'pixiefreak'); ?></span>
                </div>
            </div>
                                    ...
                                    <?php if (count($tournament) > 0): ?>
                                        ...
                                        <span class="date">
                                            ...
                                            <a href="<?php echo pixiefreak_route('match', $match->slug); ?>">
                                                <?php echo esc_html__('View match', 'pixiefreak'); ?> <i class="fas fa-play"></i>
                                            </a>
                                        </span>
                                    <?php endif; ?>
                                </div>
            ...
            <div class="section-footer mt">
                <div>
                    <h4><?php echo esc_html__('If you want to see more matches', 'pixiefreak'); ?></h4>
                    <span><?php echo esc_html__('Visit special section to see them all', 'pixiefreak'); ?></span>
                </div>
                <a href="<?php echo esc_url(get_home_url(null, 'matches/')); ?>" class="btn-default">
                    <?php echo esc_html__('All Matches', 'pixiefreak'); ?>
                </a>
            </div>
        </div>
    </section>
