...
if ( ! function_exists( 'register_ihs_otp_plugin_settings' ) ) {
	...
	function register_ihs_otp_plugin_settings() {
		...
		// Button and Notification Text Settings
		register_setting( 'ihs-otp-plugin-settings-group', 'ihs_otp_send_otp_text' );
		register_setting( 'ihs-otp-plugin-settings-group', 'ihs_otp_verify_text' );
		register_setting( 'ihs-otp-plugin-settings-group', 'ihs_otp_resend_otp_text' );
		register_setting( 'ihs-otp-plugin-settings-group', 'ihs_otp_required_text' );
		register_setting( 'ihs-otp-plugin-settings-group', 'ihs_otp_reset_pwd_via_otp' );
		register_setting( 'ihs-otp-plugin-settings-group', 'ihs_otp_pls_verify_otp_first_text' );
		register_setting( 'ihs-otp-plugin-settings-group', 'ihs_otp_pls_enter_otp_text' );
		register_setting( 'ihs-otp-plugin-settings-group', 'ihs_otp_otp_enter_incorrect_text' );
		register_setting( 'ihs-otp-plugin-settings-group', 'ihs_otp_otp_sent_to_mobile_text' );
		register_setting( 'ihs-otp-plugin-settings-group', 'ihs_otp_sending_otp_text' );
		register_setting( 'ihs-otp-plugin-settings-group', 'ihs_resend_otp_timer' );
